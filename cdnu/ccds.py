...
def load_ccds() -> List[List[tuple]]:
    """Load file with CDS locations within GRCh38 genome as a list of genes,
    where each gene is represented as a list of CDS locations. Each location is
    a 3-tuple with gene name, start index and end index."""
    cds = []
